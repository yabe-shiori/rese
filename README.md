...
**店舗情報作成について**  
  店舗情報の作成は、usersテーブルのroleカラムがmanagerであるユーザーのみ行えます。  
  
新たに店舗情報を作成する場合の手順    
1. 管理者としてログインし、管理画面で新たに店舗代表者を作成する。  
2. ログイン画面にて、先ほど作成した店舗代表者のメールアドレスとパスワードを入力し、ログインする。  
3. 店舗代表者のダッシュボード画面で、Create New Shop　をクリックする。  
4. csvファイルのアップロード、もしくは手動入力で店舗情報を作成する。    
