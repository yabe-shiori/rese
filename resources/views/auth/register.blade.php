    ...
    <form method="POST" action="{{ route('register') }}" class="w-full max-w-md">
        ...
        <div class="relative flex items-center mb-4 w-full px-4">
            ...
            <div class="relative w-full">
                <x-text-input id="name" class="block mt-1 w-full border-none focus:outline-none" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Username"/>
        ...
        <div class="relative flex items-center mb-4 w-full px-4">
            ...
            <div class="relative w-full">
                <x-text-input id="email" class="block mt-1 w-full border-none focus:outline-none" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="Email"/>
        ...
        <div class="relative flex items-center mb-4 w-full px-4">
            ...
            <div class="relative w-full">
                <x-text-input id="password" class="block mt-1 w-full border-none focus:outline-none"
                                type="password"
                                name="password"
